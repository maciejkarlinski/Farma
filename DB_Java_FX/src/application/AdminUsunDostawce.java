...
/**
 * The type Admin usun dostawce.
 */
public class AdminUsunDostawce implements Initializable {
    ...
    public void usunButtonClick(ActionEvent actionEvent) throws IOException {
        String id_dostawcy = textField.getText();
        if (id_dostawcy.equals("")) {
            ...
            try{
            String response = MainApp.client.usun("Dostawca", id_dostawcy);
